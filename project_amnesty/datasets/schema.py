...
# to the flat-store convention. project_amnesty/datasets/prepare.py stamps this into each
...
def row_to_arrays(row: dict) -> dict:
    """Arrow row → restore original shapes such as (K, T). Used by project_amnesty/datasets/dataset.py."""
