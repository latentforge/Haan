...
Usage::
    ...
    uv run python -m training.tools.derive_silence_codes
    uv run python -m training.tools.derive_silence_codes --dry-run
    uv run python -m training.tools.derive_silence_codes --require-constant
...
def derive_silence_codes(
    *,
    ...
    return {
        ...
        "probe": asdict(params),
        "per_probe": per_probe,
        "derived_by": "training/tools/derive_silence_codes.py",
    }
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(
        prog="python -m training.tools.derive_silence_codes",
        description=(
